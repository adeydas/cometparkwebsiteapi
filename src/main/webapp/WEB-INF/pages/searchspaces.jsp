...
<body>
	...
	<input type="hidden" name="lotnameholder" id="lotnameholder"
		value="${lotnameholder }" />

	<div id="map" style="width: 900px; height: 1700px;"></div>
		    	...
		    	for (i = 0; i < locations.length; i++) {  
		    		 console.log(arr[i]);
		    	      marker = new google.maps.Marker({
		    	        ...
		    	        map: map,
		    	        title: locations[i][4],
		    	        icon: "http://abhis.ws/misc/imgs/" + arr[i]
		    	      });
		    	      
		    	      //Save the markers in an array
